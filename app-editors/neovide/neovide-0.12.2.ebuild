...
# https://github.com/rust-skia/rust-skia/tree/master/skia-bindings#prebuilt-binaries-in-an-offline-environment
SRC_URI="
	https://github.com/rust-skia/skia-binaries/releases/download/0.68.0/skia-binaries-f0bea3ad919500904bb9-x86_64-unknown-linux-gnu-gl-textlayout.tar.gz -> skia-binaries.tar.gz
...
LICENSE+="
	...
	CC0-1.0 ISC LGPL-3 MIT MPL-2.0 Unicode-DFS-2016 Unlicense ZLIB
"
SLOT="0"
KEYWORDS="~amd64"
...
src_configure() {
	...
	export SKIA_BINARIES_URL="file://${DISTDIR}/skia-binaries.tar.gz"
...
src_install() {
	...
	newicon assets/neovide-256x256.png neovide.png
}
